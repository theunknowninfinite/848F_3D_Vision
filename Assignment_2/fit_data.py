...
def fit_voxel(voxels_src, voxels_tgt, args):
    ...
    for step in range(start_iter, args.max_iter):
        ...
        print("[%4d/%4d]; ttime: %.0f (%.2f); loss: %.3f" % (step, args.max_iter, total_time,  iter_time, loss_vis))
    # print(voxels_src,voxels_tgt,loss_vis)
    print(loss_vis)
    print('Done!')
...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        renderer.render_vox(voxels_src,"vox_src",cam_dist=5,cam_azi=0,cam_ele=0,image_size=512)
        renderer.render_vox(voxels_tgt,"vox_final",cam_dist=4,cam_azi=0,cam_ele=0,image_size=512)
        ...
        renderer.render_point_cloud(pointclouds_src,"pc",image_size=512,cam_dist=1)
        renderer.render_point_cloud(pointclouds_tgt,"pc_final",image_size=512,cam_dist=1)
        ...
        renderer.render_mesh(mesh_src,"source_mesh",cam_dist=1,cam_azi=90,image_size=512)
        renderer.render_mesh(mesh_tgt,"final_mesh",cam_dist=1,cam_azi=90,image_size=512)
