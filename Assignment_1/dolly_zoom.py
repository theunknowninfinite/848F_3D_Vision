...
def dolly_zoom(
    ...
    for fov in tqdm(fovs):  
        distance = distance*((torch.tan(torch.deg2rad(fov1)/2))/(torch.tan(torch.deg2rad(fov)/2)))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default="output_images/dolly.gif")
