...
def render_cow(
    cow_path="data/cow.obj", image_size=256, color=[1, 0, 0.9], device=None):
    ...
    for i in azimuth:
        ...
        R,T=pytorch3d.renderer.cameras.look_at_view_transform(5,25,i)
        # Prepare the camera:
...
if __name__ == "__main__":
    ...
    imageio.mimsave('output_images/tetra_gif.gif', my_images, duration=20,loop=0)
